...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = self.player_frame_list[self.player_frame_index]
    ...
    def animation_state(self):
        if self.rect.bottom < 300:
            ...
            if self.player_frame_index >= len(self.player_frame_list):
                self.player_frame_index = 0

            self.image = self.player_frame_list[int(self.player_frame_index)]
...
class Obstacle(pygame.sprite.Sprite):
    def __init__(self, type):
        ...
        if type == 'fly':
            ...
            self.frame_list = [snail_frame_1, snail_frame_2]
            y_pos = 300
    ...
    def animation_state(self):
        ...
        if self.animation_index >= len(self.frame_list):
            self.animation_index = 0
